---
title: "Agent Studio 多项 Bug 修复：头像显示、重复卡片、Skill 调用异常"
type: "Bug Fix"
priority: "高"
date: "2026-05-16"
status: "待审核"
channels: ""
---
# Agent Studio 多项 Bug 修复：头像显示、重复卡片、Skill 调用异常

## 核心宣传点
修复了 Agent Studio 中多个影响使用体验的 Bug：安装后不再出现重复 Agent 卡片、头像能正确显示、Agent 开发过程中 Skill 调用恢复正常。

## 原始内容
**Commit**: 18b46f46d00bedfb937add81c3dbdfee7466f495
**作者**: felix-srp
