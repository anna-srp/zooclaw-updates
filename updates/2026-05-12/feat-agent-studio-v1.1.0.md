---
title: "Agent Studio v1.1.0 上线：发布/安装/分享流程全面加固"
type: "产品基础功能更新"
priority: "高"
date: "2026-05-12"
status: "待审核"
...
# Agent Studio v1.1.0 上线：发布/安装/分享流程全面加固

## 核心宣传点

Agent Studio 完成重大升级：修复了打包后的 Agent 会错误继承 Studio 自身身份的关键 bug，新增 Stage 5（打包）与 Stage 6（分发）两阶段工作流，并通过 11 轮独立代码审查关闭了 30+ 个安全与正确性漏洞，让你创建和发布自定义 Agent 更安全、更可靠。

## 原始内容

**Commit:** `2026-05-12T09:37:56Z` by felix-srp
**SHA:** a6da8fd5928b026dd0dde1981e1004c9860dfbe9
**PR:** #118
