---
title: "DOCX 文档读取能力上线：支持将 Word 文档转为 Markdown"
type: "新功能上线"
priority: "高"
date: "2026-05-27"
status: "待审核"
...
# DOCX 文档读取能力上线：支持将 Word 文档转为 Markdown

## 核心宣传点

ZooClaw 现在可以直接读取 .docx 文件内容（含图片和修订记录），并转换为 Markdown 格式供 Agent 处理，极大提升文档处理能力。
...
**PR**: [#206](https://github.com/SerendipityOneInc/ecap-skills/pull/206)  
**作者**: felix-srp  
