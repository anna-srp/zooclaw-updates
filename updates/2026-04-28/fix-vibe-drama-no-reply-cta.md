---
title: "修复：Vibe Drama Agent 完成交付后不再沉默，用户提示正常显示"
type: "Bug Fix"
priority: "高"
date: "2026-04-28"
status: "待审核"
...
# 修复：Vibe Drama Agent 完成交付后不再沉默，用户提示正常显示

## 核心宣传点

修复了 Vibe Drama Agent 在发送视频后陷入「沉默」、用户不知道如何继续的问题：现在每个阶段交付后会正确显示下一步确认提示。

## 原始内容

**Commit**: `d94d2c0dc1febd1282d8614235c4c0f974db0324`
**仓库**: ecap-agent-pack
**作者**: david-srp
