---
title: "圆桌研究报告更紧凑更贴题：先说结论、不跑题、不啰嗦"
type: "Skill 上架/更新"
priority: "中"
date: "2026-08-09"
status: "待审核"
...
Council（圆桌研究）产出的报告改成"先给答案、再摆证据"：每个小节开头直接给结论，你问的每个问题都会被逐一回答，答不上来的会明确写进"盲点与待解问题"而不是悄悄略过；同一件事不再翻来覆去说，报告篇幅比之前紧凑约 20%。另外修复了一个语言问题——你用英文提的研究题目，报告不会再莫名其妙变成中文了。
