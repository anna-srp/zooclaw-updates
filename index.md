...
- [Pro 订阅结账支持 Stripe 优惠码，折扣后（含 0 元）也照样开通完整权益 (#3891)](updates/2026-09-24/billing-stripe-promotion-codes-pro-3891.md) — 新功能 / 外部 A
- [修复：个人订阅到期后，旧 Agent 的历史聊天、成果和文件重新可以访问 (#3894)](updates/2026-09-24/billing-unblock-legacy-agent-data-models-after-expiry-3894.md) — Bug Fix / 外部 A
- [Agent 提示卡片样式统一，点一下先填进输入框可再编辑 (#3887)](updates/2026-09-24/agents-prompt-cards-prefill-scrollbar-loading-3887.md) — 体验优化 / 外部 B
- [手机号登录的国家列表移除中国大陆 +86，其他国家短信登录保持不变 (#3892)](updates/2026-09-24/auth-remove-china-86-keep-sms-3892.md) — 体验优化 / 外部 B
- [修复：编辑 Agent 时选到不可用模型会提示更换，聊天列表不再因消息移除而崩 (#3898)](updates/2026-09-24/chat-revision-model-warning-stale-message-3898.md) — Bug Fix / 外部 B
- [修复：高负载下登录校验、订阅状态与 Builder 轮询的重复请求大幅减少 (#3885)](updates/2026-09-24/perf-cut-cpu-load-amplification-3885.md) — Bug Fix / 外部 B
- [模板弹窗底部加渐隐、侧栏改为 Recent tasks，首页去掉重复的 Agent 模块 (#3903)](updates/2026-09-24/web-template-modal-task-copy-home-files-3903.md) — 体验优化 / 外部 B
- [修复：官网跳转行业解决方案页时保留当前语言，不再跳到语言不定的页面 (#3899)](updates/2026-09-24/marketing-preserve-language-industry-links-3899.md) — Bug Fix / 外部 C
...
- [feat(agents): route v2 Auto through GPT-5.6 tiers (#3765)](updates/2026-09-18/agents-v2-auto-gpt56-tiers-3765.md) — 新功能上线 / 外部 A
- [fix(workspace): 整合 R3 首页、日程与设置导航交互改进 (#3783)](updates/2026-09-18/workspace-r3-home-schedule-settings-3783.md) — Bug Fix / 外部 B
- [fix(chat): surface recoverable credit failures outside history (#3795)](updates/2026-09-18/chat-recoverable-credit-failures-3795.md) — Bug Fix / 外部 B
- [fix(artifacts): include self-evolving agents in global library (#3805)](updates/2026-09-18/artifacts-self-evolving-agents-global-library-3805.md) — Bug Fix / 外部 B
- [feat(agents): group recent conversations by channel (#3792)](updates/2026-09-18/agents-group-recents-by-channel-3792.md) — 新功能上线 / 外部 B
- [style(chat): apply warm B2 billing notice design (#3807)](updates/2026-09-18/chat-warm-b2-billing-notice-3807.md) — 体验优化 / 外部 C
- [style(agents): refine channel cards and connected state (#3775)](updates/2026-09-18/agents-channel-cards-connected-state-3775.md) — 体验优化 / 外部 C
- [fix(web): link directly to default-English Agent Gallery (#3791)](updates/2026-09-18/web-agent-gallery-default-english-link-3791.md) — Bug Fix / 外部 C
- [fix(web): support browsers without AbortSignal.any (#3803)](updates/2026-09-18/web-abortsignal-any-fallback-3803.md) — Bug Fix / 外部 C
- [fix(designer): add concise image IP restrictions (#286)](updates/2026-09-18/designer-image-ip-restrictions-286.md) — 产品基础功能更新 / 外部 C

## 2026-09-17

- [fix(agents): pin effective global skills as inherited refs on first skill declaration (#3764)](updates/2026-09-17/agents-pin-global-skills-inherited-3764.md) — Bug Fix / 外部 A
- [feat(agents): publish shared agents with manual updates and independent copies (#3773)](updates/2026-09-17/agents-publish-shared-agents-3773.md) — 新功能上线 / 外部 A
- [feat(plugins): 接入 Skills 能力并统一侧边栏资源页面体验 (#3757)](updates/2026-09-17/plugins-skills-resource-pages-3757.md) — 新功能上线 / 外部 A
- [feat(marketing): add Agent Gallery to Solutions and navigation (#3738)](updates/2026-09-17/marketing-agent-gallery-3738.md) — 新功能上线 / 外部 A
- [feat(kb): wire share-link installs into the kb grant domain (spec L0-L18) (#3779)](updates/2026-09-17/kb-share-link-grants-3779.md) — 新功能上线 / 外部 B
- [fix(workspace): 修复 R2 工作台交互并统一资源页面样式 (#3781)](updates/2026-09-17/workspace-r2-fixes-resource-pages-3781.md) — Bug Fix / 外部 B
- [fix(agents): 优化设计面板、编辑入口和头像保存体验 (#3774)](updates/2026-09-17/agents-design-panel-avatar-save-3774.md) — Bug Fix / 外部 B
- [fix(agents): 修复头像保存同步、首页路径与全局输入框高度 (#3768)](updates/2026-09-17/agents-avatar-save-home-path-input-3768.md) — Bug Fix / 外部 B
- [fix(docx): preserve revision outputs when LibreOffice fails (#282)](updates/2026-09-17/docx-preserve-revision-outputs-282.md) — Bug Fix / 外部 B
- [fix(docx): write LibreOffice conversion output locally before copying to NFS (#281)](updates/2026-09-17/docx-libreoffice-local-conversion-281.md) — Bug Fix / 外部 B
- [fix(agents): persist exact environment pins in revisions (#3782)](updates/2026-09-17/agents-persist-environment-pins-3782.md) — 产品基础功能更新 / 外部 C
- [fix(chat): render model provider icons locally (#3770)](updates/2026-09-17/chat-local-model-provider-icons-3770.md) — Bug Fix / 外部 C
- [fix(web): 优化首页 Agent 卡片布局、选择面板与日程文案 (#3758)](updates/2026-09-17/web-home-agent-card-layout-3758.md) — Bug Fix / 外部 C
...
- [安装 Agent 不再受旧版 Bot 状态阻塞](updates/2026-07-31/agent-install-decouple.md) — 体验优化 / 外部B
- [Council 新增 Deep Research 深度研究模式](updates/2026-07-31/council-deep-research.md) — 新功能上线 / 外部A
- [定时任务页面新增引擎 Agent 计划展示](updates/2026-07-31/engine-agent-schedules.md) — 产品基础功能更新 / 外部B
- [任务卡片交互优化：一键带入 Prompt 与 Agent](updates/2026-07-31/task-card-ux.md) — 体验优化 / 外部B
- [修复 v2 Agent 模型选择显示不正确](updates/2026-07-31/v2-model-selection-fix.md) — Bug Fix / 外部B

## 2026-07-30

- [Council 调研：每次运行独立线程，审批/取消更稳定](updates/2026-07-30/council-dedicated-thread.md) — 新功能上线 / 外部B
- [Council 多模型调研功能上线（Beta）：支持调研深度与档位选择](updates/2026-07-30/council-multimodel-research-beta.md) — 新功能上线 / 外部A
- [Council 调研：运行状态实时刷新](updates/2026-07-30/council-realtime-refresh.md) — 新功能上线 / 外部B
- [飞书/企业微信一键扫码接入（引导式配置）](updates/2026-07-30/feishu-wecom-qr-setup.md) — 新功能上线 / 外部B
- [切换模型即时生效，无需重启提示](updates/2026-07-30/model-switch-no-restart.md) — 体验优化 / 外部B

## 2026-07-29

- [Agent Builder v2 上线：由全新引擎驱动，搭建 Agent 更强更稳](updates/2026-07-29/agent-builder-v2.md) — 新功能上线 / 外部B
- [聊天输入区 5 项体验优化：最近文件更全、附件图标更清晰、引用截断不再劈开表情](updates/2026-07-29/chat-composer-ux.md) — 体验优化 / 外部B
- [聊天连接失败时不再暴露技术报错：改为友好的重连提示（中英文）](updates/2026-07-29/chat-connection-failure-state.md) — 体验优化 / 外部B
- [聊天界面 5 个用户报告 Bug 批量修复：换行丢失、头像不一致、我的上传为空等](updates/2026-07-29/chat-ui-bugfix-batch.md) — Bug Fix / 外部B
- [Council 研讨技能升级：议题自动消歧、引用更完整、盲点排查、专家分工更合理](updates/2026-07-29/council-skill-quality.md) — Skill 上架/更新 / 外部B
- [Council 研讨技能：新增「单专家主笔」合成、实时赛季/序列解析、论点处就地引用](updates/2026-07-29/council-skill-synthesis.md) — Skill 上架/更新 / 外部B
- [Council 多模型专家研讨功能上线（Beta）：一个问题，多位 AI 专家协同产出深度报告](updates/2026-07-29/council-surface-beta.md) — 新功能上线 / 外部A
- [cron-job 技能安全加固：拦截把定时任务当作消息中继的不安全用法](updates/2026-07-29/cron-job-block-unsafe-relays.md) — Skill 上架/更新 / 外部B
- [知识库支持压缩包上传：拖入 .zip/.tar 一次性导入整包文件，界面按树状展开](updates/2026-07-29/kb-archive-upload.md) — 新功能上线 / 外部B
- [Engine 版 Agent 接入 Slack 也有完整向导了：一步步照做即可，不再面对空白密钥框](updates/2026-07-29/slack-guided-setup-engine.md) — 体验优化 / 外部B
- [修复 WhatsApp 部分海外号码被误加 +86 导致无法接入的问题](updates/2026-07-29/whatsapp-country-code-fix.md) — Bug Fix / 外部B

## 2026-07-28

- [定时任务（cron-job）技能升级 v2.3：飞书定时消息校验更可靠、更新提示不再误伤权限](updates/2026-07-28/cron-job-skill-hardening.md) — Skill 上架/更新 / 外部B
- [知识库协作者可浏览共享库文件，“编辑者”更名为“协作者”](updates/2026-07-28/kb-collaborator-browsing.md) — 产品基础功能更新 / 外部B

## 2026-07-27

- [修复结账/支付偶发 500 错误](updates/2026-07-27/billing-checkout-500-fix.md) — Bug Fix / 外部B
- [新增 cron-job Skill：一条命令可靠地创建/更新定时任务](updates/2026-07-27/cron-job-skill.md) — Skill 上架/更新 / 外部B
- [Agent 自带 Skill 现已真正注册并生效](updates/2026-07-27/pack-skills-register-engine.md) — 产品基础功能更新 / 外部B
- [slide-master 幻灯片 Agent：品牌配色自动守护可读性](updates/2026-07-27/slide-master-brand-contrast.md) — Agent 上架/更新 / 外部B
- [主题皮肤适配深色模式（新增 Warm Ember / Mono OLED 深色）](updates/2026-07-27/theme-skin-dark-mode.md) — 体验优化 / 外部B

## 2026-07-25

- [企业管理后台恢复 Agent Pack 上传能力](updates/2026-07-25/enterprise-admin-pack-uploads.md) — 产品基础功能更新 / 外部B
- [修复组织升级时的钱包重复配置问题](updates/2026-07-25/org-upgrade-wallet-fix.md) — Bug Fix / 外部B
...
- [聊天显示「轮次状态」，更准确地知道智能体是否在生成](updates/2026-06-18/03-feat-c…turn-status.md) — 体验优化 / 中
...
- [修复部分用户无法创建机器人的问题](2026-06-08/02-修复部分用户无法创建机器人的问题.md)
- [用量明细改为最近优先展示](2026-06-08/03-用量明细改为最近优先展示.md)
...
> ⚠️ 本日数据暂缺：GitHub API 访问因 SAML SSO 授权失效而中断，未能获取 commits。详见 `raw/2026-06-07/`。

## 2026-06-05

> ⚠️ 本日数据暂缺：GitHub API 访问因 SAML SSO 授权失效而中断，未能获取 commits。详见 `raw/2026-06-05/`。
...
- [7fe2da1-2142.md](updates/2026-06-01/7fe2da1-2142.md) — 手机号登录新增合规提示文字
- [db4cc35-2140.md](updates/2026-06-01/db4cc35-2140.md) — Agent 详情页现已支持直接使用 OpenClaw
- [a9a9ccc-2139.md](updates/2026-06-01/a9a9ccc-2139.md) — 对话输入提示符（打字效果）现在会在回复结束后正确消失
...
| 标题 | 类型 | 优先级 | 状态 |
|------|------|--------|------|
| [Agent Redeploy 不再覆盖用户数据](updates/2026-04-19/Redeploy保留用户数据修复.md) | Bug Fix | 高 | 待审核 |
| [前端素材大小自动管控](updates/2026-04-19/素材大小CI管控.md) | 产品基础功能更新 | 低 | 待审核 |

## 2026-04-18

| 标题 | 类型 | 优先级 | 状态 |
|------|------|--------|------|
| [批量 Credits 发放 + 补偿弹窗](updates/2026-04-18/批量Credits发放-补偿弹窗.md) | 产品基础功能更新 | 高 | 待审核 |
| [iOS bot 回复流式推送 + 连接稳定性增强](updates/2026-04-18/iOS-bot回复流式推送优化.md) | 产品基础功能更新 | 高 | 待审核 |
| [Sentry 监控优化 + Mattermost 事件风暴修复](updates/2026-04-18/Sentry监控覆盖优化-MM风暴修复.md) | Bug Fix | 高 | 待审核 |

## 2026-04-17

| 标题 | 类型 | 优先级 | 状态 |
|------|------|--------|------|
| [新 Agent 上架：Deco 家居装饰 Agent](updates/2026-04-17/Deco家居装饰Agent上架.md) | Agent 上架/更新 | 高 | 待审核 |
| [新增 VS Code devcontainer 支持](updates/2026-04-17/VS-Code-devcontainer支持.md) | 产品基础功能更新 | 中 | 待审核 |
| [侧边栏 "AI Specialists Hub" 改名](updates/2026-04-17/AI-Specialists-Hub侧边栏改名.md) | 产品基础功能更新 | 低 | 待审核 |

## 2026-04-16

| 标题 | 类型 | 优先级 | 状态 |
|------|------|--------|------|
| [版本升级浮动弹窗 + Changelog 独立页面](updates/2026-04-16/版本升级弹窗-Changelog独立页面.md) | 产品基础功能更新 | 高 | 待审核 |
